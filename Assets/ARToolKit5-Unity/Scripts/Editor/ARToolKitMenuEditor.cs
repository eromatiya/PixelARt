...
public class ARToolKitMenuEditor : MonoBehaviour {
    ...
    private const  string VERSION               = "ARToolKit/ARToolKit for Unity Version 5.3.2r1";
    ...
    private const  string GET_TOOLS_MESSAGE     = "ARToolKit for Unity Version 5.3.2r1! <b>To make your own markers, you'll need to download our tools.</b>\n" +
